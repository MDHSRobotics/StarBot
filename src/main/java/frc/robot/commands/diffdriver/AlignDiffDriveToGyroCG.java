...
public class AlignDiffDriveToGyroCG extends CommandBase {

    public GenericHID controller;
    private DiffDriver m_diffDriver;
    private int m_targetAngle = -1;

    public AlignDiffDriveToGyroCG(DiffDriver diffDriver, GenericHID controller) {
        Logger.setup("Constructing Command: AlignDiffDriveToGyroCG...");
    ...
    public void end(boolean interrupted) {
        if (interrupted) {
            System.out.println("--");
            Logger.ending("Interrupting Command: AlignDiffDriveToGyroCG...");
        }
    }
